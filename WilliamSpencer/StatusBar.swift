...
class StatusBar: SKNode {
    ...
    private func setupBarBackground() {
        ...
        // Make an SKSpriteNode that is a Black color and the size of barBackgroundSize
    ...
    private func setupStarsCollected(collected: Int) {
        ...
        starsIcon.run(SKAction.rotate(byAngle: 1.0, duration: 2.5))
    }
    ...
    func updateLives(lives: Int) {
        ...
        // Get the X and Y points where should draw the sprites
        var offsetX = CGFloat()
        let offsetY = barBackground.size.height / 2
